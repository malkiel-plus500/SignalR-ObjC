Pod::Spec.new do |s|
  ...
  s.source   	 = { :git => 'https://github.com/malkiel-plus500/SignalR-ObjC.git', :tag => '2.0.3' }
  ...
  s.subspec 'Core' do |sp|
    ...
    sp.dependency 'AFNetworking', '~> 3.0', :subspecs => ['Reachability', 'Serialization', 'Security', 'NSURLSession']    
